  ...
  constructor() {
    super(
      ...
      [
        ...
        new Clearing(4364, 2336, Suit.fox, [new Slot(4187, 2370), new Slot(4404, 2139, true)]),
        ...
        new Clearing(2054, 1250, Suit.rabbit, [new Slot(1856, 1176), new Slot(2124, 1508, true)]),
        new Clearing(3050, 2160, Suit.mouse, [new Slot(2966, 1994), new Slot(3142, 2142), new Slot(2946, 2290, true)]),
        new Clearing(1496, 2444, Suit.fox, [new Slot(1488, 2628), new Slot(1694, 2414, true)]),
      ],
      [
        [0, 4], [0, 9], [0, 8],
        [1, 4], [1, 5], [1, 9],
