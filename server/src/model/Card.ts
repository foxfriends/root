...
export class Card {
  ...
  static get birdy_bindle() {
    return "birdy_bindle";
  }
  static get armorers() {
    return "armorers";
  }
  static get woodland_runners() {
    return "woodland_runners";
  }
  static get arms_trader() {
    return "arms_trader";
  }
  static get crossbow() {
    return "crossbow";
  ...
  static get brutal_tactics() {
    return "brutal_tactics";
  }
  static get royal_claim() {
    return "royal_claim";
  }
  static get gently_used_knapsack() {
    return "gently_used_knapsack";
  }
  static get root_tea() {
    return "root_tea";
  }
  static get travel_gear() {
    return "travel_gear";
  }
  static get protection_racket() {
    return "protection_racket";
  }
  static get foxfolk_steel() {
    return "foxfolk_steel";
  }
  static get anvil() {
    return "anvil";
  }
  static get stand_and_deliver() {
    return "stand_and_deliver";
  }
  static get tax_collector() {
    return "tax_collector";
  }
  static get favor_of_the_foxes() {
    return "favor_of_the_foxes";
  }
  static get smugglers_trail() {
    return "smugglers_trail";
  }
  static get a_visit_to_friends() {
    return "a_visit_to_friends";
  }
  static get bake_sale() {
    return "bake_sale";
  }
  static get command_warren() {
    return "command_warren";
  }
  static get better_burrow_bank() {
    return "better_burrow_bank";
  }
  static get cobbler() {
    return "cobbler";
  }
  static get favor_of_the_rabbits() {
    return "favor_of_the_rabbits";
  }
  static get mouse_in_a_sack() {
    return "mouse_in_a_sack";
  }
  static get investments() {
    return "investments";
  }
  static get sword() {
    return "sword";
  }
  static get scouting_party() {
    return "scouting_party";
  }
  static get codebreakers() {
    return "codebreakers";
  }
  static get favor_of_the_mice() {
    return "favor_of_the_mice";
  }
  static get dominance() {
    return "dominance";
  }
  static get spy() {
    return "spy";
  ...
  static isDominance(card: Card) {
    return card.name === Card.dominance;
  }
  static isSpy(card: Card) {
    return card.name === Card.spy;
  }
...
const Cards = [
  ...
  new Card(
    Suit.bird,
    [Suit.bird, Suit.bird, Suit.bird, Suit.bird],
    Card.royal_claim,
  ),
  ...
  new Card(
    Suit.fox,
    [Suit.mouse, Suit.mouse, Suit.mouse],
    Card.stand_and_deliver,
  ),
  new Card(
    Suit.fox,
    [Suit.mouse, Suit.mouse, Suit.mouse],
  ...
  new Card(
    Suit.rabbit,
    [Suit.rabbit, Suit.rabbit, Suit.rabbit],
    Card.favor_of_the_rabbits,
  ),
